      ...
      <div className="page-details">
        ...
        <div className="page-details-row">
            <div className="section-description">
                <p>As part of your assessment to become a Foster Caregiver, you must have a Medical Report completed by your Primary Health Care Provider. The report will be used to assess any health considerations related to providing care for a foster child.</p>

                <p><strong>Step 1</strong>: Download one copy of the required <a href="/Medical-Report-on-Applicant.pdf" download className="bright">Medical Report on Applicant</a> form for each applicant. If you and your spouse/partner are both applying to provide care, you must complete separate, individual forms.</p>
                ...
                <p><strong>Step 4</strong>: Have them forward the completed report(s) along to MCFD as per the contact information on the form.</p> 
